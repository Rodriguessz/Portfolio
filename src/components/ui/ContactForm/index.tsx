  ...
  return (
    <div className=" max-w-2xl m-auto">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <button
          className="group/btn relative block h-10 w-full rounded-md bg-gray-200 dark:bg-gradient-to-br from-black to-neutral-600 font-medium dark:text-white  shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] bg-zink dark:bg-zinc-800 dark:from-zinc-900 dark:to-zinc-900 dark:shadow-[0px_1px_0px_0px_#27272a_inset,0px_-1px_0px_0px_#27272a_inset]"
          type="submit"
        >
          {loading ? (
            <div className="w-5 h-5 border-2 border-zinc-500 dark:border-zinc-200 border-t-transparent rounded-full animate-spin absolute inset-0 m-auto" />
          ) : (
            <>
              {t("sendButton")} &rarr;
            </>
...
const LabelInputContainer = ({
  ...
  return (
    <div className={cn("flex w-full flex-col space-y-2 text-black dark:text-zinc-300", className)}>
      {children}
    </div>
  );
};
