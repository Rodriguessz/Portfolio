...
export const MovingTechs = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-0 max-w-lg m-auto overflow-hidden [mask-image:linear-gradient(to_right,transparent,white_20%,white_80%,transparent)]",
        className,
      )}
    >
      <ul
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[170px] flex justify-center"
            key={item.name}
          >
            <blockquote>
              <div
